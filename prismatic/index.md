...
Brands whose storefront has to carry the identity, not just list the catalog. Independent labels, makers, and design-led catalogs that want a storefront with a point of view — editorial product pages, expressive composition, and real merchandising depth — without ever opening a code editor. The register a store lands in is a preset decision; the capability below is the theme.
...
- **Product gallery** with six desktop layouts (carousel and grid variants) plus four mobile layouts, thumbnail rail, variant-image swap, and a contained zoom lightbox
- **Specification tables** that render from blocks or directly from a product metafield
- **Merchandising and editorial depth** — bundle builder, shop-the-look, hot spots, and creator spotlight sections
- **Online Store 2.0** — JSON templates, section groups, theme blocks, app blocks
