...
- **Alternating asymmetric rows.** Stack several instances with `split_ratio: 67-33`, flipping `image_position` row to row, `width: edge`, alternating light and dark schemes. The classic Prismatic editorial spine.
