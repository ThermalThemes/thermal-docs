...
description: Every section in Prismatic's library, grouped by category, with one-line descriptions and links to per-section settings documentation.
---

# Sections reference

Prismatic ships 33 drop-in sections plus the header, footer, and announcement bar — 52 section files in total — built on the thermal-base substrate. Sections are grouped into layout, marketing, product, and content categories. Every section is documented with its settings, blocks, and intended use.
