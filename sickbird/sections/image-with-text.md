...
- **Alternating asymmetric rows.** Stack several instances with `split_ratio: 67-33`, flipping `image_position` row to row, `width: edge`, alternating paper and ink schemes. The classic Sickbird editorial spine.
